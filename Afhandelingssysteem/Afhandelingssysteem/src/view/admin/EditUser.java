...
public class EditUser extends javax.swing.JPanel {
    ...
    Employee employee = new Employee(Integer.parseInt(Session.getInstance().getValue("EditEmployee")));
    ...
    private void setDefaultValues() {
        try {
            ...
            Insertion.setText(employee.getInsertion());
            Lastname.setText(employee.getLastName());
            Location.setText(employee.getLocation());
            Employeenumber.setText(Integer.toString(employee.getEmployeeNumber()));
     ...
     * Password is an optional field, and therefore requires a if-statements to ensure we don't change it when its not needed.
     * @return 
     */
    ...
    private void fieldsValidator()  {
        if (Username.getText().length() < 3 || Username.getText().length() > 45) {
    ...
    private void submit1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submit1ActionPerformed
        ...
        try {
            // Validate the fields, because we throw an exception we do not need to use an if-statement here.
            fieldsValidator();
