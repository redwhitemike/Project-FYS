...
public class AddMissingLuggage extends javax.swing.JPanel {
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        try {
            ...
            customerValues.put("LastName", LastName.getText());
            customerValues.put("HomeAddress", Address.getText());
            customerValues.put("Zipcode", ZipCode.getText());
            customerValues.put("City", City.getText());
            customerValues.put("Country", Country.getText());
            customerValues.put("Phone", PhoneNumber.getText());
            customerValues.put("Email", eMail.getText());
            customerValues.put("FlightNumber", FlightNumber.getText());
...
>>>>>>> 102ed56eb0276697d2e82a69ab3fdffb70dc7fa3:Afhandelingssysteem/Afhandelingssysteem/src/view/desk/AddMissingLuggage.java
